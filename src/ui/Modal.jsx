  ...
  return (
    open && (
      <div className="fixed left-0 top-0 z-40 h-screen w-full bg-secondary-800 bg-opacity-30 backdrop-blur-sm">
        <div
          ref={ref}
          className="max-h-[calc(100vh-4rem)] fixed left-1/2 top-1/2 w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-lg bg-secondary-0 p-4 shadow-md transition-all duration-500 md:max-w-lg"
        >
